...
### JHipster Customize
<br> JHipster Custimization NavBar  on navbar.component.html 
```
<a class="navbar-brand logo float-left" routerLink="/" (click)="collapseNavbar()">
     <span class="logo-img"></span>
     <span class="navbar-title">JBlog</span><span class="navbar-version"> JBlog AlperBlog</span>
</a>
```
### JPosts on the main page custimize the main page 
List the posts with title , body and writer
<br> This is the home.component.html side listing post
```
<div class="row">
    <div class="col-md-3">
